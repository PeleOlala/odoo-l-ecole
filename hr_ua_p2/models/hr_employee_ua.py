...
class EmployeeUA(models.Model):
    """
    Il s'agit une classe heridataire qui ajouter famille military et etc.
    """
    ...
    address_registration_id = fields.Many2one(
        'res.partner', 'Address',
        help='Enter here the address of registration of the employee,'
