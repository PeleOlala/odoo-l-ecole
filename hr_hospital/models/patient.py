...
def _compute_age_patient(self):
    date1 = datetime.datetime.strptime(self.date_de_naissance, DEFAULT_SERVER_DATETIME_FORMAT)
    date_ah=datetime.date.today()
    self.age= (date_ah.year-date1.year-1 )+(date_ah.month+12-date1.month)//12
