...
class ResearchCatalog(models.Model):
    _name = 'hr_hospital_4.research_catalog'
    ...
    complete_name = fields.Char(
        ...
        store=True)
    parent_id = fields.Many2one('hr_hospital_4.research_catalog', 'Parent catalog', index=True, ondelete='cascade')
    parent_path = fields.Char(index=True)
    child_id = fields.One2many('hr_hospital_4.research_catalog', 'parent_id', 'Child Class')
