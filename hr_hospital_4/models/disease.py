...
class Disease(models.Model):
    _name = 'hr_hospital_4.disease'
    _description = 'disease'

    name = fields.Char()
    disease_catalog_id = fields.Many2one(
        comodel_name='hr_hospital_4.disease_catalog',
        string='Catalog',
        required=False)


class DiseaseCatalog(models.Model):
    _name = 'hr_hospital_4.disease_catalog'
    ...
    disease_ids = fields.One2many(comodel_name='hr_hospital_4.disease', inverse_name='disease_catalog_id')
